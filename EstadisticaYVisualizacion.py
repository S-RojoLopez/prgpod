...
# %%
fumadores['bmi_range']=pd.cut(fumadores.bmi,[0,18.5,25,30,100],labels=['Bajo peso', 'Normal', 'Sobrepeso', 'Obesidad'])
fumadores.head()

sns.boxplot(x="bmi_range",y="charges",data=fumadores,palette="rainbow")

# %%
sns.scatterplot(data=fumadores, x="age", y="charges", hue="bmi")

# %%
sns.scatterplot(data=nofumadores, x="age", y="charges",  hue="bmi")
